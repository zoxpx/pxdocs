...
$(function() {
  ...
  */
  ...
  $('.docs-content table').addClass('table table-hover table-bordered');


  $('#dsToggleSidebar').click(function(){
    $('.myLeftSidebar').toggle('slow')
  ...
  */
  ...
  function activateVersionMenu() {
    ...
    allVersions.forEach(function(version) {
        ...
        var versionOption = '<a class="dropdown-item" href="'+url+'">' + version + '</a>';

        $('#version-menu .dropdown-menu').append(versionOption);
    })

    $('#versionBtn').text('Version: ' + VERSIONS_CURRENT);
  ...
  var pageContent = $('#mainContentArea')
  ...
  */
  $('.highlight').each(function(i) {
    ...
    var copyDiv = $([
      '<div class="copy-link">',
        '<button id="clipboard-icon-' + i + '" class="button" data-toggle="tooltip" title="Copy to Clipboard">',
  ...
  */
  ...
  $('.contactFormBtn').click(function(){
    $('.marketoContactform').toggle('slow')
