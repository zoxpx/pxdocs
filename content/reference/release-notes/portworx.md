...
* Introducing [Storage pool caching](/concepts/pool-caching/). This is for new clusters only.
...
* [Portworx CSI](/portworx-install-with-kubernetes/storage-operations/csi/) driver is now generally available for Kubernetes 1.13 and higher.
