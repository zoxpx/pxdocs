...
|**Improvement Number**|**Improvement Description**|
|----|----|
| PWX-10125 | The Portworx `pxctl service` CLI command now supports [pool deletion](https://2.2.docs.portworx.com/reference/cli/service#pxctl-service-pool-delete). |
