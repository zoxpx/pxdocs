...
| io_profile       	| IO Profile can be used to override the I/O algorithm Portworx uses for the volumes. Supported values are [db](/install-with-other/operate-and-maintain/performance-and-tuning/tuning#db), [sequential](/install-with-other/operate-and-maintain/performance-and-tuning/tuning#sequential), [random](/install-with-other/operate-and-maintain/performance-and-tuning/tuning#random), [cms](/install-with-other/operate-and-maintain/performance-and-tuning/tuning#cms)                                                                                                                                                                                                                                           	| io_profile: "db"    	|
...
| journal     	| (PX 1.3 and higher) Flag to indicate if you want to use journal device for the volume's data. This will use the journal device that you used when installing Portworx. This is useful to absorb frequent syncs from short bursty workloads. Default: false                                                                                                                                                                                             	| journal: "true"     	|
