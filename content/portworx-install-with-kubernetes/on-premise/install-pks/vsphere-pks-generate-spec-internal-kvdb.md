...
curl -fsL -o px-spec.yaml "https://install.portworx.com/2.1?kbver=$VER&c=portworx-demo-cluster&b=true&pks=true&vsp=true&ds=$VSPHERE_DATASTORE_PREFIX&vc=$VSPHERE_VCENTER&s=%22$VSPHERE_DISK_TEMPLATE%22"
```
