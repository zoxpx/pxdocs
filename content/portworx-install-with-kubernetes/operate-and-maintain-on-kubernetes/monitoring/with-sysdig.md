...
1. Follow the [Kubernetes Agent Installation Steps](https://docs.sysdig.com/en/kubernetes-agent-installation-steps.html) in the Sysdig documentation to deploy the following YAML files:
