...
{{<info>}}
If you are going to re-install Portworx, you should wipe out the filesystem from the disks so that they
...
{{<info>}}
Only if you were running _Portworx_ with internal kvdb, you will have to cleanup _Portworx_ metadata from DC/OS Zookeeper.
{{</info>}}
