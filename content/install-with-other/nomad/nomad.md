...
The feature, is also referred to as `inline volume creation` . For more information, [click here](/reference/CLI/data-volumes/create-and-manage-volumes) and see the section _Inline volume spec_.
